package com.personal.xiri.data.net.interceptor;

import com.personal.xiri.data.util.DeviceUtils;
...
//            commomParamsMap.put(LANGUAGE, DeviceUtils.getLanguage());
//            commomParamsMap.put(SDK, DeviceUtils.getAndroidSDKVersion() + "");
//
//
//            //get请求的封装
